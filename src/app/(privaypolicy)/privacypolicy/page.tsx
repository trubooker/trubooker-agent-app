...
const TermsAndConditions = () => {
  ...
  return (
    ...
    <div className="max-w-6xl lg:text-justify bg-white text-gray-900 mx-auto px-10 py-10">
      {/* Title Section */}
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          Welcome to TruBooker Connectors&apos; Referral System! These Terms of
          Use and Policies (&quot;Agreement&quot;) outline the legal
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            transportation services, collectively referred to as &quot;TruBooker
            Platforms.&quot;
          </li>
          <li>
          ...
          <li>
            <strong>Vehicle Operator:</strong> An independent driver/sailor who
            operates the Vehicle for trips marketed and sold by TruBooker.
            ...
            terms and conditions, which can differ from those of TruBooker. The
            Vehicle Operator is identified during the booking process, in the
            booking confirmation, and on the ticket.
          </li>
          <li>
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                <li>
                  Riots, civil unrest, embargoes, war, hostilities, pandemic, or
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          are not permitted to use the TruBooker Platform or act as a TruBooker
          Connector.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          action constitutes the electronic equivalent of Your signature, and is
          a binding acknowledgment that they accept and agree to all the terms,
          policies, and conditions of this Agreement. This electronic signature
          holds the same legal effect as a written signature under applicable
          laws and regulations. If You do not agree to any of the terms of this
          Agreement, You are not permitted to use the TruBooker Platform, You
          must refrain from ticking the box, and should not proceed with
          registration or participation in the TruBooker Connectors. Referral
          System.
        </p>
      </section>
      ...
      {/* Sections (4) */}
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-4">4. Modification of Terms</h2>
        <p className="mb-4">
          TruBooker reserves the right to amend this Agreement at any time, with
          or without prior notice. Any changes may be communicated through the
          TruBooker Platform by push notification. Changes will be effective
          upon posting updated terms on the TruBooker platform and continued
          participation after such changes constitutes acceptance of the revised
          terms.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            including vehicle operation, insurance, and licensing requirements.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>6.3. Onboarding Support:</strong> Helping Vehicle Operators
            complete the onboarding process.
          </li>
          <li>
            <strong>6.4. Post-Referral Engagement:</strong> Providing ongoing
            support to ensure Vehicle Operators can manage bookings effectively.
          </li>
          <li>
            <strong>6.5. Non-Interference:</strong> You must not interfere with
            any agreements between TruBooker and the Vehicle Operator after the
            referral is made.
          </li>
          <li>
            <strong>6.6. Terms of Use and Privacy Policy:</strong> You must make
            sure to get the Vehicle Operators aware of, understand, and agree to
            the TruBooker Terms of Use and the TruBooker Privacy Policy.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-4">
          7. Vehicle-Specific Requirements/Vehicle Operator Responsibilities and
          Eligibility
        </h2>
        <p className="mb-2">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>7.3. Licensing and Documentation:</strong> Vehicle Operators
            must hold valid vehicle licenses, including any commercial driving
            permits required for operating larger vehicles or multiple passenger
            buses.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          Connectors will earn N200 (Two Hundred Naira) for every trip marketed
          and sold by the Vehicle Operator via the TruBooker platform. The total
          referral reward for any Vehicle Operator shall not exceed 1000 naira,
          regardless of the number of trips. Payments will be credited
          incrementally as the Vehicle Operator completes trips, and the minimum
          withdrawal threshold is N1000 (One Thousand Naira).
        </p>
        <p className="mb-2">
          Referral rewards are intended for the original recipient and cannot be
          transferred, sold, or reassigned to another party under any
          circumstances.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Each TruBooker Connector may refer an unlimited number of Vehicles and
          Vehicle Operators. However, TruBooker reserves the right to verify all
          referrals and determine, at its sole discretion, whether they meet the
          TruBooker criteria. Only verified and approved referrals will be
          eligible for rewards, if any. TruBooker also reserves the right to
          modify, suspend, or terminate the TruBooker Connector Referral system
